...
def plan_scene(category, ordinal, seed, generation, llm, scene_id):
    styles = generation.variations.architectural_styles or ["neoclassical", "modern", "brutalist"]
    environments = generation.variations.environments or ["urban", "forest", "coastal"]
